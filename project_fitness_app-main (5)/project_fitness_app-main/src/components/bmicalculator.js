...
const BMICalculator = () => {
  ...
  return (
    ...
    <div className='bmicalculator'>
      ...
      <button onClick={calculateBMI} className='btn btn-bmi' style={{ textDecoration: 'none', width: '400px', textAlign: 'center', background: '#FF2625', fontSize: '22px', textTransform: 'none', color: 'white', borderRadius: '8px'  }}>
        Calculate BMI
      </button>
      {bmi !== null && (
        <div>
